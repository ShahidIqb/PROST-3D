...
def run_seq_pipeline(seqfile,blast_prog=pblast,outdir=None,e=1e-9):
	...
	seqname1 = seqname1[0]
	#print(seqname1)
	blastfile=tmpdir+seqname1+'11.blast'
	hsspfile=tmpdir+seqname1+'11.hssp'
...
def ddgun_features(seqfile, wild, mut_pos, mutant, outdir, hhblits_db):
