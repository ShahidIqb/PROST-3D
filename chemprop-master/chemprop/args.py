...
class TrainArgs(CommonArgs):
    ...
    # General arguments
    data_path: str = '/Users/siqb0003/PycharmProjects/PyG_Demo/chemprop-master/tests/data/regression.csv'
    ...
    show_individual_scores: bool = True
    ...
    def process_args(self) -> None:
        ...
        self.smiles_columns = chemprop.data.utils.preprocess_smiles_columns(
            path=self.data_path,
            #path='/Users/siqb0003/PycharmProjects/PyG_Demo/chemprop-master/tests/data/reaction_solvent_regression.csv',
