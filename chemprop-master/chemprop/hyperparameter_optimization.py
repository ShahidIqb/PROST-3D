...
SPACE = {
    'hidden_size': hp.quniform('hidden_size', low=150, high=500, q=50),
    'depth': hp.quniform('depth', low=1, high=5, q=1),
    'dropout': hp.quniform('dropout', low=0.0, high=0.4, q=0.05),
    'ffn_num_layers': hp.quniform('ffn_num_layers', low=6, high=9, q=1)
}
